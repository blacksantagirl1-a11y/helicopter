...
namespace SlimUI.ModernMenu
{
	public class UIMenuManager : MonoBehaviour
	{
		...
		[Tooltip("Theme màu áp dụng cho menu")]
		public Theme theme;
		private int themeIndex;
		[Tooltip("Dữ liệu màu của các theme")]
		...
		[Tooltip("Panel màn hình loading")]
		public GameObject loadingMenu;
		[Tooltip("The loading bar Slider UI element in the Loading Screen")]
		public Slider loadingBar;
		[Tooltip("Nhãn hướng dẫn phím để tiếp tục sau khi tải xong")]
		public TMP_Text loadPromptText;
		[Tooltip("Phím người chơi nhấn để tiếp tục khi bật waitForInput")]
