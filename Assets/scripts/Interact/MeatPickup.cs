...
public class MeatPickup : InventoryPickup
{
    private const string DefaultItemAssetPath = "Assets/Resources/Inventory/Meat.asset";
    private const string DefaultItemResourcePath = "Inventory/Meat";
